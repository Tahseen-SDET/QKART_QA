...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='root']/div/div[2]/div[1]/div/div[1]/div/div[1]")));
            return false;
        } catch (Exception e) {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
            ...
            for(WebElement elem : addresses) {
                if(elem.findElement(By.xpath("//*[@id='root']/div/div[2]/div[1]/div/div[1]/div/div[1]/p")).getText().equals(addressToSelect)) {
                    elem.click();
                    return false;
                }
            }
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement errorMessg = driver.findElement(By.id("notistack-snackbar"));
            if (errorMessg.getText().equals("You do not have enough balance in your wallet for this purchase")) {
                return true;
            }
            return false;
        } catch (Exception e) {
