...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Failure_Scenario", "TestCase01");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Failure_Scenario", "TestCase02");
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "Failure_Scenario", "TestCase03");
            ...
            if (result.verifySizeChartExists()) {
                ...
                if (result.openSizechart()) {
                    ...
                    if (result.validateSizeChartContents(expectedTableHeaders, expectedTableBody,
                        ...
                        takeScreenshot(driver, "Failure_Scenario", "TestCase04");
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Failure_Scenario", "TestCase05");
        }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        homePage.clickCheckout();
        Thread.sleep(5000);
        status = homePage.verifyProductAtCheckOut("Xtend Smart Watch");
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            logStatus("End TestCase",
                    "Test Case 7: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Failure_Scenario", "TestCase07");
            return false;
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        logStatus("Start Testcase", "Test Case 8: Verify MultiTab Scenario for Items in Cart ",
                "DONE");
        ...
        jscript.executeScript(
                "window.open('https://crio-qkart-frontend-qa.vercel.app/' , '_blank');");
        Thread.sleep(2000);
        windowSwitcher(driver, 1);
        Thread.sleep(2000);

        if (driver
                .findElement(By.xpath(
                        "//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[1]"))
                .getText().contains("YONEX Smash Badminton Racquet")) {
            status = true;
            logStatus("End TestCase", "Test Case 8: Verify MultiTab Scenario for Items in Cart: ",
                    status ? "PASS" : "FAIL");
            driver.close();

        }
        windowSwitcher(driver, 0);
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        Boolean status = true;
        logStatus("Start Testcase",
                "Test Case 9: Verify MultiTab Scenario for Privacy Policy & Terms Of Service Page links ",
                "DONE");
        ...
        String homeLink1 = driver.getCurrentUrl();
        if (!homeLink1.equals("https://crio-qkart-frontend-qa.vercel.app/")) {
            return false;
        }
        ...
        WebElement privacyPolicy = driver.findElement(By.xpath("//*[@id='root']/div/div[2]/h2"));
        if (!privacyPolicy.getText().contains("Privacy Policy")) {
            return false;
        }
        ...
        String homeLink2 = driver.getCurrentUrl();
        if (!homeLink2.equals("https://crio-qkart-frontend-qa.vercel.app/")) {
            return false;
        }

        windowSwitcher(driver, 2);
        // Set<String> handles1 = driver.getWindowHandles();
        // driver.switchTo().window(handles1.toArray(new String[handles1.size()])[2]);
        WebElement tos = driver.findElement(By.xpath("//h2[text()='Terms of Service']"));
        if (!tos.getText().contains("Terms of Service")) {
            return false;
        }
        driver.close();
    ...
    public static void windowSwitcher(RemoteWebDriver driver, int tabIndex) {
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        logStatus("Start Testcase", "Test Case 10: Verify the functionality of Contact us link ",
                "DONE");
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        WebElement nameElem = driver.findElement(By.xpath("//input[@placeholder='Name']"));
        nameElem.sendKeys("crio user");

        WebElement emailElem = driver.findElement(By.xpath("//input[@placeholder='Email']"));
        emailElem.sendKeys("criouser@gmail.com");

        WebElement messageElem = driver.findElement(By.xpath("//input[@placeholder='Message']"));
        messageElem.sendKeys("Testing the contact us page");

        WebElement contactNowButton = driver.findElement(By.xpath(
        ...
        status = true;
        logStatus("End TestCase", "Test Case 9: Verify the functionality of Contact us link : ",
                status ? "PASS" : "FAIL");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        logStatus("Start TestCase",
                "Test Case 11: Verify the 3 Advertisements are available at order confirmed page ",
                "DONE");
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Failure_Scenario", "TestCase11");
        }
        ...
        String orderPlacedPageurl = driver.getCurrentUrl();
        ...
        logStatus("Step", "Test Case 11: Verify tht Advertisement 1 is clickable ", "DONE");
        WebElement buyIpadMini = driver.findElement(By.xpath("//button[text()='Buy Now']"));
        buyIpadMini.click();
        driver.switchTo().parentFrame();

        if (!driver.getCurrentUrl().equals(orderPlacedPageurl)) {
            status = true;
            logStatus("Step", "Test Case 11: Verify tht Advertisement 1 is clickable : ",
                    status ? "PASS" : "FAIL");
        }
        driver.navigate().back();
        WebElement ad2 = driver.findElement(By.xpath("(//iframe)[2]"));
        driver.switchTo().frame(ad2);
        logStatus("Step", "Test Case 11: Verify tht Advertisement 2 is clickable ", "DONE");
        WebElement galaxy = driver.findElement(By.xpath("//button[text()='Buy Now']"));
        galaxy.click();
        driver.switchTo().parentFrame();

        if (!driver.getCurrentUrl().equals(orderPlacedPageurl)) {
            status = true;
            logStatus("End TestCase11", "Test Case 11: Verify tht Advertisement 2 is clickable : ",
                    status ? "PASS" : "FAIL");
        }
