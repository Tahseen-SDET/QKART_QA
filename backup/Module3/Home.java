...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div/div[3]/div/div[2]/div/div/div[1]/p[1]")) , 
                ...
                if (title.contains(productName)) {
                    while (true) {
                        ...
                        if (quantity > actuallQuantity) {
                            ...
                            wait1.until(ExpectedConditions.textToBePresentInElement(actuallQuantityWebelement, String.valueOf(actuallQuantity+1)));
                            ...
                            wait2.until(ExpectedConditions.textToBePresentInElement(actuallQuantityWebelement, String.valueOf(actuallQuantity-1)));
                        } else if (quantity == actuallQuantity) {
                            break;
                        }
                        // Thread.sleep(2000);
