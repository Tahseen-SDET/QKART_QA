...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        wait.until(ExpectedConditions.or(ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/login") , ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/register")));
